...
public class v1_9_R1 implements me.furnace.API
{
  private Config util = new Config();
  
  public v1_9_R1() {}
  
  public String translate(String msg) { return net.md_5.bungee.api.ChatColor.translateAlternateColorCodes('&', msg); }
